...
%   Detailed explanation goes here
    ...
    [logExposure1,irradiance1]=createHDR(pixelArray,logT, 0.5,1);
    [logExposure2,irradiance2]=createHDR(pixelArray,logT, 0.5,2);
    [logExposure3,irradiance3]=createHDR(pixelArray,logT, 0.5,3);
